...
function directive(): IDirective {
    return {
        replace: true,
        restrict: 'E',
        templateUrl: `${RootsConst.directive}/parameter-export-choices/parameter-export-choices.html`,
        scope: {
            exportChoices: '=',
            onChange: '&'
        },
...
export const lystoreParameterExportChoices = ng.directive('lystoreParameterExportChoices', directive);